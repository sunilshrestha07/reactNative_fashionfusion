...
export default function Sale() {
   ...
   const filteredData = data.slice(0, data.length - (data.length % 2));
   ...
   return (
      <ScrollView style={{backgroundColor:isDark?Colors.dark.background:Colors.light.background,paddingBottom:20}}>
